...
sed -i.bak "s/# default_admin_user=admin/default_admin_user=\$ToBeChanged/" ~/inventory
sed -i.bak "s/# default_admin_password=password/default_admin_password=\$ToBeChanged/" ~/inventory
sed -i.bak "s/awx_secret_key=awxsecret/awx_secret_key=\$ToBeChanged/" ~/inventory
sed -i.bak "s/pg_username=awx/pg_username=\$ToBeChanged/" ~/inventory
sed -i.bak "s/pg_password=awxpass/pg_password=\$ToBeChanged/" ~/inventory
sed -i.bak "s/pg_database=awx/pg_database=\$ToBeChanged/" ~/inventory
